...
// On hosted preview surfaces, broker the auth session to the parent editor over
...
export function brokeredPreviewStorage() {
  ...
  // Post only to the real editor ancestor, validated as a trusted origin, so the
